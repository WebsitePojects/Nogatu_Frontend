          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex gap-3">
              {[
                ...
                <a key={label} href="#" aria-label={label} className="w-10 h-10 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center hover:bg-brand-gold motion-safe:transition-all motion-safe:duration-300 group cursor-pointer">
                  <svg className="w-4 h-4 fill-current text-white/50 group-hover:text-white motion-safe:transition-colors" viewBox="0 0 24 24"><path d={icon} /></svg>
                </a>
              ))}
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-white/50">
              <li className="flex gap-3">
                <svg className="w-5 h-5 flex-shrink-0 mt-0.5 text-brand-gold" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
                <span>94 Navarro Street, Maligaya Park, Brgy 177, Caloocan City</span>
              </li>
              <li className="flex gap-3">
                <svg className="w-5 h-5 flex-shrink-0 text-brand-gold" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" /></svg>
                <span>+632 0908 888 888</span>
              </li>
              <li className="flex gap-3">
                <svg className="w-5 h-5 flex-shrink-0 text-brand-gold" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
