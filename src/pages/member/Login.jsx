  ...
  return (
    <div className="min-h-screen flex bg-cover bg-center bg-no-repeat bg-[url('/img/portalBG_light.png')] dark:bg-[url('/img/portalBG_dark.png')]">
      ...
      >
        ...
        <div
          className="absolute -top-32 -left-32 size-[480px] rounded-full pointer-events-none"
          style={{ background: 'radial-gradient(circle, rgba(212,175,55,0.12) 0%, transparent 65%)', filter: 'blur(40px)' }}
        />
        {/* Gold orb — bottom right */}
        <div
          className="absolute bottom-0 right-0 size-[360px] rounded-full pointer-events-none translate-x-1/3 translate-y-1/3"
          ...
          <ul className="space-y-3">
            {features.map((f) => (
              <li key={f} className="flex items-center gap-3.5">
                <span
                  className="size-5 rounded-full flex items-center justify-center flex-shrink-0 text-white"
                  style={{
      ...
      >
        ...
        <div className="relative z-10 w-full max-w-[400px]">
          ...
          <div
            className="mt-4 rounded-2xl border p-4 text-left shadow-sm backdrop-blur-md"
            style={{
